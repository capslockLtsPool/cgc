...
// Copyright (c) 2013 The Caogencoin developers
...
uint256 hashGenesisBlock("0x00000f1400dcefe04838a0e42174c794a1e189593c5800fd11ddb3f7122c0791");
static const unsigned int timeGenesisBlock = 1394280000;//Human time (GMT): Sat, 08 Mar 2014 12:00:00 GMT
...
const string strMessageMagic = "Caogencoin Signed Message:\n";
...
static const int64 nTargetTimespan = 60 * 60; // 60 minutes, 60 blocks
...
//                           (pindex->nHeight==91880 && pindex->GetBlockHash() == uint256("0x00000000000743f190a18c5577a3c2d2a1f610ae9601ac046a38084ccb7cd721")));
    ...
    if ((vtx[0].GetValueOut() > GetBlockValue(pindex->nHeight, nFees, pindex->nBits))&&(pindex->nHeight!=1224))
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "CGC - CaogenCoin - Coins for ordinary people.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("e8ecad504b866487d6082e5bd68e81a1d503a12f9f0c819c48d37fafcb58b73d"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CaogencoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CaogencoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("CaogencoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("caogencoin-miner");
    ...
    try { loop {
        ...
        printf("Running CaogencoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("CaogencoinMiner terminated\n");
        throw;
    }
}
