...
const QString BITCOIN_IPC_PREFIX("caogencoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click caogencoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start caogencoin: click-to-pay handler");
    else
...
{
    // clicking on caogencoin: URLs creates FileOpen events on the Mac:
