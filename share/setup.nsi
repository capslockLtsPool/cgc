...
!define MUI_FINISHPAGE_RUN $INSTDIR\caogencoin-qt.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/caogencoin-qt.exe
    File /oname=COPYING.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/caogencoind.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Quark.lnk" $INSTDIR\caogencoin-qt.exe
    ...
    WriteRegStr HKCR "quark" "" "URL:Caogencoin"
    WriteRegStr HKCR "quark\DefaultIcon" "" $INSTDIR\caogencoin-qt.exe
    WriteRegStr HKCR "quark\shell\open\command" "" '"$INSTDIR\caogencoin-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\caogencoin-qt.exe
