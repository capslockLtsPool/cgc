TEMPLATE = app
TARGET = caogencoin-qt
macx:TARGET = "Caogencoin-Qt"
VERSION = 1.0.0
...
!win32 {
    ...
    QMAKE_CXXFLAGS *= -static -fstack-protector-all
    QMAKE_LFLAGS *= -static -fstack-protector-all
...
contains(RELEASE, 1) {
    !win32:!macx {
        ...
        #LIBS += -Wl,-Bdynamic
	LIBS += -Wl,-Bstatic # use static linking
    }
}
